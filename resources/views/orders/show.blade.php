        ...
        <div class="grow">
            ...
            <form method="POST" class="card !p-0" action="{{ route('orders.update', ['order' => $order->id]) }}">
                <div class="p-6 space-y-3">
                    ...
                    @if($order->type == \App\Enum\PaymentType::COD)
                        ...
                        <div class="mt-2 ml-6 space-y-2">
                            <div class="flex items-center gap-2">
                                ...
                                <input type="text" @class(['grow', '!border-red-300' => $errors->has('shipping_unit')]) name="shipping_unit" id="shipping-unit"/>
                            </div>
                            <div class="flex items-center gap-2">
                                <label for="shipping-code" class="w-32">Mã vận đơn <span class="text-red-400">*</span></label>
                                <input type="text" @class(['grow', '!border-red-300' => $errors->has('shipping_code')]) name="shipping_code" id="shipping-code"/>
                            </div>
                        </div>
                    @else
                        <p class="flex gap-2">
                    ...
                    <textarea id="note" name="note" rows="3" class="w-full"></textarea>
                </div>
